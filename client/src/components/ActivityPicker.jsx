...
import { Search as SearchIcon, Plus, Clock, DollarSign, MapPin, Landmark, Utensils, Compass, Ticket, Smile } from 'lucide-react';
          ...
          {activities.map((a) => (
            ...
            >
              <div className="flex items-start gap-3">
                <div className="size-8 rounded bg-[#FBF6ED] border border-[#16302B]/15 flex items-center justify-center text-xs text-[#16302B] flex-shrink-0 mt-0.5">
                  <Ticket className="size-4 text-[#16302B]" />
                </div>
                <div>
                  ...
                  {a.city?.name && (
                    <p className="font-mono text-[10px] text-[#16302B]/50 mt-0.5 flex items-center gap-1">
                      <MapPin className="size-3 text-[#E15B4F]" /> {a.city.name}
                    </p>
                  )}
                  {a.description && (
                  ...
                  <div className="flex items-center gap-3 mt-1.5 font-mono text-[10px] text-[#16302B]/60">
                    <span className="font-semibold text-[#16302B] flex items-center gap-0.5">
                      <DollarSign className="size-3 text-[#16302B]" /> {a.cost}
                    </span>
                    <span className="flex items-center gap-0.5">
                      <Clock className="size-3 text-[#16302B]/60" /> {a.durationHours}h
                    </span>
                  </div>
                </div>
              </div>
